...
class ModelArguments:
    ...
    wrap_q_p: int = field(default=None)
...
class RetrievalDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        positive_doc = self.wrap_passage(positive_doc)
        ...
        for j, hard_negative_doc in enumerate(hard_negative_docs):
            ...
            #     truncation=True,
            # ).input_ids[0]
            hard_negative_doc = self.wrap_passage(hard_negative_doc)
...
def train():
    ...
    retrieval_train_dataset = RetrievalDataset(retrieval_train_raw, training_args.n_hard_negative, tokenizer,
