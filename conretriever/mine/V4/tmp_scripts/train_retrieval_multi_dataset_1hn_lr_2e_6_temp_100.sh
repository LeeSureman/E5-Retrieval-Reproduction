...
output_dir="checkpoint_dir/multi_dataset_1hn_lr_2e_6_temp_100"
use_lora="0"
learning_rate="2e-6"
temperature="100"
do_grad_cache="1"
...
data_root_dir="./multi_retrieval_data_top_200_hn_filtered"
...
torchrun --nproc_per_node=$nproc_per_node --master_port=20001 ./mine/V4/train_retrieval.py \
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/multi_dataset_1hn_lr_2e_6_temp_100 \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_2e_6_temp_100/checkpoint-100 \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_2e_6_temp_100/checkpoint-200 \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_2e_6_temp_100/checkpoint-300
do
