...
output_dir="checkpoint_dir/multi_dataset_lr_5e_6_temp_100_bs_256_same_token_gc"
use_lora="0"
learning_rate="5e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/multi_dataset_lr_5e_6_temp_100_bs_256_same_token_gc/checkpoint-100
do
