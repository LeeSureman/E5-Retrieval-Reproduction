...
output_dir="checkpoint_dir/msmarco_lr_1e_5_temp_100_bs_256_same_token_gc"
use_lora="0"
learning_rate="1e-5"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/multi_dataset_lr_1e_5_temp_100_bs_256_same_token_gc/checkpoint-200
do
