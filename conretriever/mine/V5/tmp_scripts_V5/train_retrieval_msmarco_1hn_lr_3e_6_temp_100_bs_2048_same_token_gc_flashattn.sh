...
output_dir="checkpoint_dir/msmarco_1hn_lr_3e_6_temp_100_bs_2048_same_token_gc_flash_attn"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_3e_6_temp_100_bs_2048_same_token_gc
do
...
#task_names="NQ"
task_names="ArguAna TRECCOVID Touche2020 FiQA2018 NFCorpus SciFact SCIDOCS QuoraRetrieval ClimateFEVER DBPedia FEVER HotpotQA NQ ClimateFEVER"
#task_names="ArguAna"
