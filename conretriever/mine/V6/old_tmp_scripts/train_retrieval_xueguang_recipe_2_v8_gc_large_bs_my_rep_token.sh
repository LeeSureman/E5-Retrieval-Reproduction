output_dir="checkpoint_dir/msmarco_with_hn_no_lora_lr_1e_5_xueguang_recipe_1_at_2024_1_22_wrap_qp_v8_gc_large_bs_my_rep_token"
...
torchrun --nproc_per_node=4 --master_port=20001 ./mine/V3/train_retrieval.py \
