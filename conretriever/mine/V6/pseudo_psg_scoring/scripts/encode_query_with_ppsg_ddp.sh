...
task="fiqa"
input_dir="pseudo_psg_for_run/msmarco_hybrid_plus_e5_hybrid_plus_synthetic/slim_orca_sample_32_temp_1.5"
input_fp="$input_dir/${task}.jsonl"
encode_query_or_doc="query"
...
embedding_output_dir="$input_dir/query_embeddings/$task/${total_gpu}_shards"
