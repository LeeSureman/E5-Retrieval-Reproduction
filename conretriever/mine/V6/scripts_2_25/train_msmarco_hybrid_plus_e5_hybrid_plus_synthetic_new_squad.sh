...
output_dir="checkpoint_dir/msmarco_hybrid_plus_e5_hybrid_plus_synthetic_new_squad"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_hybrid_plus_e5_hybrid_plus_synthetic_new_squad
do
