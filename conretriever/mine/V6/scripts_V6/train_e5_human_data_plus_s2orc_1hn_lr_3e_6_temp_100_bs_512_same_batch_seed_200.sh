...
output_dir="checkpoint_dir/e5_human_data_plus_s2orc_batch_same_task_bs_512_seed_200"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
data_root_dir="retrieval_data_for_run/e5_human_data_plus_s2orc"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/e5_human_data_plus_s2orc_batch_same_task_bs_512_seed_200
do
