...
output_dir="checkpoint_dir/my_multi_data_plus_medi_batch_same_task_bs_512_seed_200"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/my_multi_data_plus_medi_batch_same_task_bs_512_seed_200
do
