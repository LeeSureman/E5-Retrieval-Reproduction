...
output_dir="checkpoint_dir/msmarco_1hn_lr_2e_6_temp_100_small_bs_gradient_accumulation"
use_lora="0"
learning_rate="2e-6"
temperature="100"
do_grad_cache="0"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_2e_6_temp_100_small_bs_gradient_accumulation/checkpoint-600
do
