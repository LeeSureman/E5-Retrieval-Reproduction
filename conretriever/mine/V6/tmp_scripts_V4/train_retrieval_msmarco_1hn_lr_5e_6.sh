...
output_dir="checkpoint_dir/msmarco_1hn_lr_5e_6"
use_lora="0"
learning_rate="5e-6"
do_grad_cache="1"
...
torchrun --nproc_per_node=4 --master_port=20001 ./mine/V4/train_retrieval.py \
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_5e_6 \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_5e_6/checkpoint-100
do
