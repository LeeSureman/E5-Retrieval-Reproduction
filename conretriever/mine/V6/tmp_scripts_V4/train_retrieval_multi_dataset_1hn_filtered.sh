...
output_dir="checkpoint_dir/multi_dataset_1hn_filtered_new"
use_lora="0"
learning_rate="1e-5"
do_grad_cache="1"
...
torchrun --nproc_per_node=8 --master_port=42001 ./mine/V4/train_retrieval.py \
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/multi_dataset_1hn_filtered/checkpoint-200 \
../../fast_chat/checkpoint_dir/multi_dataset_1hn_filtered/checkpoint-300 \
../../fast_chat/checkpoint_dir/multi_dataset_1hn_filtered
do
