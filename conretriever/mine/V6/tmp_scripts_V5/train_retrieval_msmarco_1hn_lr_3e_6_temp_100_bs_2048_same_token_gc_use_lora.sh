...
output_dir="checkpoint_dir/msmarco_1hn_lr_3e_6_temp_100_bs_2048_same_token_gc_use_lora"
use_lora="1"
learning_rate="1e-4"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_3e_6_temp_100_bs_2048_same_token_gc_use_lora
do
...
#task_names="NQ"
task_names="ArguAna TRECCOVID Touche2020 FiQA2018 NFCorpus SciFact SCIDOCS QuoraRetrieval DBPedia FEVER HotpotQA NQ"
#task_names="ArguAna"
