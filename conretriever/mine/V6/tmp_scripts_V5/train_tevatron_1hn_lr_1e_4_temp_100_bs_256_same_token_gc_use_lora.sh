...
output_dir="checkpoint_dir/tevatron_lr_1e_4_temp_100_bs_256_same_token_gc_use_lora"
use_lora="1"
learning_rate="1e-4"
temperature="100"
do_grad_cache="1"
...
torchrun --nproc_per_node=$nproc_per_node --master_port=20001 ./mine/V5/train_retrieval.py \
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/tevatron_lr_1e_4_temp_100_bs_256_same_token_gc_use_lora/checkpoint-600 \
../../fast_chat/checkpoint_dir/tevatron_lr_1e_4_temp_100_bs_256_same_token_gc_use_lora/checkpoint-1200 \
../../fast_chat/checkpoint_dir/tevatron_lr_1e_4_temp_100_bs_256_same_token_gc_use_lora
do
