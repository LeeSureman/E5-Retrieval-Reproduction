...
output_dir="checkpoint_dir/msmarco_nq_hotpotqa_fever_batch_not_same_task_bs_2048"
use_lora="0"
learning_rate="5e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_nq_hotpotqa_fever_batch_not_same_task_bs_2048/checkpoint-400
do
