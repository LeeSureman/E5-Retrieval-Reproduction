...
output_dir="checkpoint_dir/my_multi_data_batch_same_task_bs_512_use_lora_1e_4"
use_lora="1"
learning_rate="1e-4"
lora_r=16
temperature="100"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/my_multi_data_batch_same_task_bs_512_use_lora_1e_4
do
