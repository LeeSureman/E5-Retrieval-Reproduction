...
output_dir="checkpoint_dir/my_multi_data_batch_same_task_bs_512_lr_3e_6_bs_1024_epoch_2"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/my_multi_data_batch_same_task_bs_512_lr_3e_6_bs_1024_epoch_2
do
