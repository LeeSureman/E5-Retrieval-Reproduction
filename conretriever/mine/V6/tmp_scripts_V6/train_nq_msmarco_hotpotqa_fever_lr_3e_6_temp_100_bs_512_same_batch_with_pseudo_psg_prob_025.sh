...
output_dir="checkpoint_dir/nq_msmarco_hotpotqa_fever_with_pseudo_psg_prob_025"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/nq_msmarco_hotpotqa_fever_with_pseudo_psg_prob_025
do
...
#task_names="NQ"
task_names="NQ HotpotQA FEVER MSMARCO"
#task_names="ArguAna"
...
batch_per_gpu=128 \
pseudo_passage_fp="mistral_instruct_pseudo_psg" \
