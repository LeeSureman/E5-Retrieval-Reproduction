...
output_dir="checkpoint_dir/nq_msmarco_hotpotqa_fever_with_pseudo_psg_prob_05_new"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/nq_msmarco_hotpotqa_fever_with_pseudo_psg_prob_05_new
do
