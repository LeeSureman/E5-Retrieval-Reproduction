...
output_dir="checkpoint_dir/nq_msmarco_with_pseudo_psg_prob_05"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
data_root_dir="nq_and_msmarco_dir"
pseudo_psg_root_dir="nq_and_msmarco_pseudo_psg"
pseudo_psg_prob="0.5"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/nq_msmarco_with_pseudo_psg_prob_05
do
