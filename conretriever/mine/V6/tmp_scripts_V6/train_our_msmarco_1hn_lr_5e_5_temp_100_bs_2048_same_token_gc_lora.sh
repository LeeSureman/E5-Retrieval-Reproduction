...
output_dir="checkpoint_dir/our_msmarco_batch_same_task_bs_2048_use_lora"
use_lora="1"
learning_rate="5e-5"
temperature="100"
do_grad_cache="1"
...
data_root_dir="./tevatron_msmarco_psg_our_hn"
...
torchrun --nproc_per_node=$nproc_per_node --master_port=43001 ./mine/V6/train_retrieval.py \
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/our_msmarco_batch_same_task_bs_2048_use_lora
do
...
#task_names="NQ"
task_names="ArguAna TRECCOVID Touche2020 FiQA2018 NFCorpus SciFact SCIDOCS QuoraRetrieval MSMARCO"
#task_names="ArguAna"
