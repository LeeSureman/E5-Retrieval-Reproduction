...
# msmarco psg的hn是我们自己处理的
output_dir="checkpoint_dir/pure_our_multi_data_batch_same_task_bs_512"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
data_root_dir="pure_our_multi_retrieval_data_top_200_hn_filtered"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/pure_our_multi_retrieval_data_top_200_hn_filtered
do
