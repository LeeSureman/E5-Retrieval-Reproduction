...
output_dir="checkpoint_dir/pure_our_multi_data_batch_same_task_bs_512_lr_5e_6"
use_lora="0"
learning_rate="5e-6"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/pure_our_multi_data_batch_same_task_bs_512_lr_5e_6
do
