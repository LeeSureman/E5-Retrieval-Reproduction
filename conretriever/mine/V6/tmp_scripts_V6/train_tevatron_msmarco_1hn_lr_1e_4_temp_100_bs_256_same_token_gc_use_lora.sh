...
output_dir="checkpoint_dir/tevatron_msmarco_batch_same_task_bs_256"
use_lora="1"
learning_rate="1e-4"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/tevatron_msmarco_batch_same_task_bs_256/checkpoint-600 \
../../fast_chat/checkpoint_dir/tevatron_msmarco_batch_same_task_bs_256/checkpoint-1000
do
