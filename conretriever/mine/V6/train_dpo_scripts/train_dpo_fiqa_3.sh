...
dpo_data_path="${retriever_ckpt_dir}/dpo_data/$task/ignore_neg_5_min_pos_sim_0.1_rejected_2_none_psg_0.json"
...
sft_output_dir="${model_name_or_path}/${task}_further_sft_3"
