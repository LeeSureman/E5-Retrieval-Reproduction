...
dpo_data_path="${retriever_ckpt_dir}/dpo_data/$task/ignore_neg_5_min_pos_sim_0.05_rejected_3_none_psg_0.json"
...
dpo_output_dir="$sft_output_dir/further_dpo"
  ...
  dpo_output_dir="$sft_output_dir/${task}_further_dpo_2"
