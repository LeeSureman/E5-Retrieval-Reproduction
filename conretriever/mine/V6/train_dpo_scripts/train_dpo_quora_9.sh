...
dpo_data_path="${retriever_ckpt_dir}/dpo_data/$task/tmp4/train.json"
eval_dpo_data_path="${retriever_ckpt_dir}/dpo_data/$task/tmp4/test.json"
...
dpo_output_dir="$sft_output_dir/further_dpo"
  ...
  dpo_output_dir="$sft_output_dir/${task}_further_dpo_5"
