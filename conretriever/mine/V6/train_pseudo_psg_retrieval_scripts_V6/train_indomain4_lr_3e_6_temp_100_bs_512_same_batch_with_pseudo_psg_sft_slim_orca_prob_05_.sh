...
output_dir="checkpoint_dir/nq_msmarco_hotpotqa_fever_with_pseudo_psg_sft_slim_orca_prob_05"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
data_root_dir="nq_msmarco_fever_hotpotqa_data_dir"
#pseudo_psg_root_dir="train_pseudo_psg"
pseudo_psg_root_dir="/remote-home/xnli/mycode/fast_chat/train_pseudo_psg/silm_orca/temperature_0.7"
pseudo_psg_prob="0.5"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/nq_msmarco_hotpotqa_fever_with_pseudo_psg_sft_slim_orca_prob_05
do

model_dtype=fp16
OUTPUT_DIR="$ckpt_dir/mteb_evaluation/$model_dtype"
#OUTPUT_DIR="e5mistral_evaluation_pseudo_psg"
mkdir -p $OUTPUT_DIR
...
batch_per_gpu=128 \
pseudo_passage_fp="/remote-home/xnli/mycode/fast_chat/train_pseudo_psg/silm_orca/temperature_0/test" \
