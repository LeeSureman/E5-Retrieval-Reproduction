...
output_dir="checkpoint_dir/msmarco_hybrid_plus_e5_hybrid_plus_synthetic_2_25_psg_temp_10"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
data_root_dir="retrieval_data_for_run/msmarco_hybrid_plus_e5_hybrid_plus_synthetic_quora_light"
pseudo_psg_root_dir="pseudo_psg_for_run/msmarco_hybrid_plus_e5_hybrid_plus_synthetic/slim_orca_sample_1_temp_1.0"
pseudo_psg_prob="0.5"
...
torchrun --nproc_per_node=$nproc_per_node --master_port=42001 ./mine/V6/train_retrieval_with_pseudo_psg.py \
    ...
    --seed $seed \
    --pseudo_psg_root_dir $pseudo_psg_root_dir \
    --pseudo_psg_prob $pseudo_psg_prob \
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_hybrid_plus_e5_hybrid_plus_synthetic_2_25_psg_temp_10
do
...
batch_per_gpu=32 \
pseudo_passage_fp="pseudo_psg_for_test/slim_orca_sft" \
how_to_use_pseudo_passage="concat" \
doc_embedding_cache_dir="../../fast_chat/checkpoint_dir/msmarco_hybrid_plus_e5_hybrid_plus_synthetic_2_25_psg_temp_10/test_doc_cache" \
