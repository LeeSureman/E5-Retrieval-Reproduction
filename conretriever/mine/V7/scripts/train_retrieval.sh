output_dir="checkpoint_dir/msmarco_with_hn_no_lora_lr_1e_5_hn_bge"
...
data_path="/remote-home/xnli/mycode/msmarco_data/with_hn/tmp_msmarco_with_hn_bge.jsonl"
