...
output_dir="checkpoint_dir/msmarco_bge_plus_e5_bge_plus_synthetic_2_25"
use_lora="0"
learning_rate="3e-6"
temperature="100"
do_grad_cache="1"
...
data_root_dir="retrieval_data_for_run/msmarco_bge_plus_e5_bge_plus_synthetic"
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_bge_plus_e5_bge_plus_synthetic_2_25
do
