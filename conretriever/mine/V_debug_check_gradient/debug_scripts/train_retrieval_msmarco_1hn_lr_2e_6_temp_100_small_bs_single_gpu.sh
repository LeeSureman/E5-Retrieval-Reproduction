...
#output_dir="checkpoint_dir/msmarco_1hn_lr_2e_6_temp_100_small_bs"
output_dir="tmp_debug_2"
use_lora="0"
learning_rate="2e-6"
temperature="100"
do_grad_cache="0"
...
data_root_dir="./msmarco_for_debug_16"
...
torchrun --nproc_per_node=$nproc_per_node --master_port=20001 ./mine/V_debug_check_gradient/train_retrieval.py \
...
for ckpt_dir in \
../../fast_chat/checkpoint_dir/msmarco_1hn_lr_2e_6_temp_100_small_bs/checkpoint-600
do
