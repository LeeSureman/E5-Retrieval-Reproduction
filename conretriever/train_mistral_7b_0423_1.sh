# 5w lwang synthetic data without neg doc. baseline

output_dir="checkpoint_dir/5w_lwang_syn_0423_1"
use_lora="1"
learning_rate="5e-5"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
/remote-home/ctzhu/paper_exp/xn_paper2_v2/fast_chat/checkpoint_dir/5w_lwang_syn_0423_1
do
