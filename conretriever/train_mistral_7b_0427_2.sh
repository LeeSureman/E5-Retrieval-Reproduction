# 7.1w lwang self-lwang (discipline batch) synthetic data without neg doc.

output_dir="checkpoint_dir/7.1w_lwang_self_lwang_discipline_syn_0427_2"
use_lora="1"
learning_rate="5e-5"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
/remote-home/ctzhu/paper_exp/xn_paper2_v2/fast_chat/checkpoint_dir/7.1w_lwang_self_lwang_discipline_syn_0427_2
do
