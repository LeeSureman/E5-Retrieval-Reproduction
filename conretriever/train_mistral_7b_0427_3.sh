# 7.1w lwang self-lwang (discipline batch) synthetic data without neg doc. lwang 和 self-lwang 的数据按 batch-size=128 交叉混合

output_dir="checkpoint_dir/7.1w_lwang_self_lwang_mix_discipline_syn_0427_3"
use_lora="1"
learning_rate="5e-5"
temperature="100"
do_grad_cache="1"
...
data_root_dir="/remote-home/ctzhu/paper_exp/xn_paper2_v2/train_data/lwang_self-lwang-discipine_7.1w_mix"
...
for ckpt_dir in \
/remote-home/ctzhu/paper_exp/xn_paper2_v2/fast_chat/checkpoint_dir/7.1w_lwang_self_lwang_mix_discipline_syn_0427_3
do
