# 3.5w msmarco-psg without neg doc

output_dir="checkpoint_dir/3.5w_msmarco-psg_0428_1"
use_lora="1"
learning_rate="5e-5"
temperature="100"
do_grad_cache="1"
...
for ckpt_dir in \
/remote-home/ctzhu/paper_exp/xn_paper2_v2/fast_chat/checkpoint_dir/3.5w_msmarco-psg_0428_1
do
