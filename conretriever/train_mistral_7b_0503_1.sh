# 3.5w self (discipline batch) querylen-10 synthetic data without neg doc

output_dir="checkpoint_dir/3.5w_self_querylen-10_discipline_syn_0503_1"
use_lora="1"
learning_rate="5e-5"
temperature="100"
do_grad_cache="1"
...
data_root_dir="/remote-home/ctzhu/paper_exp/xn_paper2_v2/train_data/self_3.5w_discipline_querylen-10"
...
for ckpt_dir in \
/remote-home/ctzhu/paper_exp/xn_paper2_v2/fast_chat/checkpoint_dir/3.5w_self_querylen-10_discipline_syn_0503_1
do
