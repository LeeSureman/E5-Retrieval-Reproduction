# task-lwang-general-specific-v4_query-v44_pos-v26_6.7w_batch-126 without neg doc (discipline batch)

output_dir="checkpoint_dir/task-lwang-general-specific-v4_query-v44_pos-v26_6.7w_syn_discipline_0510_2"
use_lora="1"
learning_rate="5e-5"
temperature="100"
do_grad_cache="1"
...
data_root_dir=/remote-home/ctzhu/paper_exp/xn_paper2_v2/train_data/task-lwang-general-specific-v4_query-v44_pos-v26
...
# torchrun --nproc_per_node=$nproc_per_node --master_port=42002 ./mine/V8/train_retrieval.py \
...
for ckpt_dir in \
/remote-home/ctzhu/paper_exp/xn_paper2_v2/fast_chat/checkpoint_dir/task-lwang-general-specific-v4_query-v44_pos-v26_6.7w_syn_discipline_0510_2
do
