# task-insub_query-v44_pos-v26_3.1w without neg doc

output_dir="checkpoint_dir/task-insub_query-v44_pos-v26_3.1w_syn_0511_1"
use_lora="1"
learning_rate="5e-5"
temperature="100"
do_grad_cache="1"
...
data_root_dir=/remote-home/ctzhu/paper_exp/xn_paper2_v2/train_data/task-insub_query-v44_pos-v26
...
torchrun --nproc_per_node=$nproc_per_node --master_port=42002 ./mine/V7/train_retrieval.py \
...
for ckpt_dir in \
/remote-home/ctzhu/paper_exp/xn_paper2_v2/fast_chat/checkpoint_dir/task-insub_query-v44_pos-v26_3.1w_syn_0511_1
do
