...
model_name_or_path="../../fast_chat/sft_ckpt/slim_orca_full/fiqa_further_sft/further_dpo"
temperature=0
...
pseudo_passage_output_dir="/remote-home/xnli/mycode/fast_chat/train_pseudo_psg/silm_orca/temperature_$temperature/test"
