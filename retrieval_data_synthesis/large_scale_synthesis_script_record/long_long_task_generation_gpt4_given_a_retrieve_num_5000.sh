...
python brainstorm_retrieval_task.py \
    ...
    --task_type $task_type \
    --specify_output_dir "synthetic_data_2024_2_19_prompt_task_2/gpt4_given_a_retrieve/$task_type" \
...
python gen_synthetic_data_according_to_tasks.py \
  ...
  --input_dir "synthetic_data_2024_2_19_prompt_task_2/gpt4_given_a_retrieve" \
